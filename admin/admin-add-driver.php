<?php
  ...
  if(isset($_POST['add_driver']))
  {
      ...
      $query="insert into tms_user (u_fname, u_lname, u_phone, u_addr, u_category, u_email) values(?,?,?,?,?,?)";
      $stmt = $mysqli->prepare($query);
      $rc=$stmt->bind_param('ssssss', $u_fname, $u_lname, $u_phone, $u_addr, $u_category, $u_email);
      $stmt->execute();
      if($stmt)
      {
          $succ = "Driver Added";
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Are you really really really really sure you want to logout?</div>
